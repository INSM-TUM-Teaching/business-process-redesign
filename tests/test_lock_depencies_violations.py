...
def test_locked_dependency_preserved_no_violations():  
    ...
    assert locked_dependencies_preserved(matrix, modified_matrix, locked_dependencies, True) == True
...
def test_locked_dependency_preserved_violations():  
    ...
    # perform the test whether the function returns the correct value - True in this case since no changes were performed 
    assert locked_dependencies_preserved(matrix, modified_matrix, locked_dependencies, True) == False
...
def test_get_violated_locked_dependencies():  
    ...
    # perform the test whether the function returns the correct value - True in this case since no changes were performed 
    assert get_violated_locked_dependencies(matrix, modified_matrix, locked_dependencies, True) == violated_dependencies